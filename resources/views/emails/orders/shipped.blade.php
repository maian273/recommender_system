    ...
    <tr>
        ...
        <td>
            ...
            <div class="m_-5422268179432338897section">
                ...
                <div class="m_-5422268179432338897section-content m_-5422268179432338897section-content--justify">
                    <ul>
                        ...
                        <li>Trong một số trường hợp, Sora Mobile sẽ thực hiện cuộc gọi tự động hoặc gửi tin nhắn đến số điện thoại bạn đã đăng ký để xác nhận đơn hàng. Để đơn hàng được xử lý nhanh chóng, bạn vui lòng thực hiện theo hướng dẫn của cuộc gọi hoặc nội dung tin nhắn nhận được. Nếu Sora Mobile không nhận được phản hồi từ bạn, đơn hàng sẽ được ngưng thực hiện do xác nhận không thành công.</li>
                        <li>Trong trường hợp đơn hàng có dịch vụ kèm theo, Sora Mobile sẽ liên hệ với bạn để xác nhận một số thông tin liên quan đến việc thực hiện dịch vụ (thời gian, địa điểm,...).</li>
                        <li>Bạn không cần phải trả bất kỳ khoản tiền đặt cọc nào. Vui lòng liên hệ chúng tôi tại trang <a href="http://skyphone.com/lienhe" target="_blank">Liên hệ</a>.</li>
                    </ul>
                </div>
            </div>
            <div class="m_-5422268179432338897section">
                ...
                <div class="m_-5422268179432338897section-content">
                    ...
                    <div class="m_-5422268179432338897two-column-right">
                        ...
                        Email: <a href="mailto:+maian27396@gmail.com" target="_blank">{{$user->email}}</a>
                    </div>
                </div>
            </div>
            <div class="m_-5422268179432338897section">
            ...
            <div class="m_-5422268179432338897section m_-5422268179432338897section--dark">
                ...
                <div class="m_-5422268179432338897section-content">
                    <p>Bạn có thể tham khảo thêm thông tin tại trang <a href="http://skyphone.com" target="_blank">Trung tâm hỗ trợ</a> hoặc liên hệ với chúng tôi tại trang <a href="http://skyphone.com/lienhe" target="_blank" >Liên hệ</a>.</p>
                </div>
            </div>
        </td>
    </tr>
