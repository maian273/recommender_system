...
INSERT INTO `orders` (`id`, `user_id`, `date_order`, `total`, `payment`, `note`, `created_at`, `updated_at`) VALUES
...
(11, 'Bkaprodx', 'maian27396@gmail.com', '$2y$10$yRsiiEragPKJyGs67iNYRuiM3W87ZLItH2CVI08xyEBe7kj9TiUz6', '01657831525', 'Ha Noi', 'RRFuYUUQD4rh34LV3zTrE7bqZGcVZVCq5g85XHxI63brgv3HkHCnPbGZ5qyY', '2018-02-03 08:28:03', '2018-12-21 08:49:18'),
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `orders_ibfk_1` (`user_id`) USING BTREE;
